	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand visible-xs-block visible-sm-block" href="index.php">Data Bootcamp</a>
				<a class="navbar-brand hidden-xs hidden-sm" href="index.php">Data Bootcamp</a>
			</div>
		...
		<div class="content">
			...
			if(isset($_GET['aksi']) == 'delete'){
				...
				if(mysqli_num_rows($cek) == 0){
					...
					$delete = mysqli_query($koneksi, "DELETE FROM Name, Hobby,Category Where Name='$data' ");
					if($delete){
